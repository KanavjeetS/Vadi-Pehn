...
class NeMoSafetyClient(SafetyClient):
    ...
    def __init__(self, base_url: str = settings.safety_proxy.url, http_client: httpx.AsyncClient | None = None) -> None:
    ...
    async def check_input(
        ...
        *,
        ...
        except (httpx.TimeoutException, httpx.RequestError, httpx.HTTPStatusError, KeyError, ValueError):
