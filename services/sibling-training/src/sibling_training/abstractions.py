...
class TrainingConfig:
    ...
    checkpoint_interval_seconds: int = 300  # Max 5-min GPU checkpoint intervals per SD §10 / plan
...
class GRPOConfig(TrainingConfig):
    ...
    group_size_g: int = 4  # Number of sampled completions per prompt for relative baseline
